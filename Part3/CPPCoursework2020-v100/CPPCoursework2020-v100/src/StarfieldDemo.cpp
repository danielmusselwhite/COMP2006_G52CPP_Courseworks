...
void StarfieldDemo::copyAllBackgroundBuffer()
{
	...
	//m_pForegroundSurface->copyRectangleFrom(m_pBackgroundSurface, 0, 0, getWindowWidth(), getWindowHeight(), m_iOffset, 0);
	//m_pForegroundSurface->copyRectangleFrom(m_pBackgroundSurface, getWindowWidth()-m_iOffset, 0, getWindowWidth(), getWindowHeight(), m_iOffset-getWindowWidth(), 0);
