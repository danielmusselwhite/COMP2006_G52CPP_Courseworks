...
void CW3_SimpleGun::attack() {
	...
	m_pGameEngine->appendObjectToArray(new CW3_SimpleBullet(m_pWielder->getCurrentXCoordinate(), m_pWielder->getCurrentYCoordinate(), m_pGameEngine, 10, 10, m_pGameEngine->getDrawableObjectVectorSize(), shootAngle));
}